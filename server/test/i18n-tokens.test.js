...
// across all six locales. A key added to en (or any locale) without the others fails CI,
...
test('i18n: apitoken.* keys have full parity across all 6 locales (drift fails CI)', () => {
