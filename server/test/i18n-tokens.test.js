...
// across all listed locales. A key added to en (or any locale) without the others fails CI,
...
const LOCALES = ['en', 'es', 'fr', 'de', 'pt', 'nl', 'ru'];
...
test('i18n: apitoken.* keys have full parity across listed locales (drift fails CI)', () => {
