...
export function render(container) {
  const guides = [
    ...
    { icon: '&#127912;', title: 'help.guide.posters.title', steps: ['help.guide.posters.s1', 'help.guide.posters.s2', 'help.guide.posters.s3', 'help.guide.posters.s4', 'help.guide.posters.s5'] },
