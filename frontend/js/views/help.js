  ...
  container.innerHTML = `
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:16px;margin-bottom:32px">
      ${[
        ...
        { icon: '&#127912;', title: 'Posters and Designs', steps: ['In Content Library, New poster opens the Studio (Layerhub) editor for layered posters', 'Create design opens the Suika design editor in a new window (canvas sizes: landscape, portrait, e-paper)', 'Save / publish writes a PNG into the library; screens play the image offline — not the editor JSON', 'Edit poster / Edit design reopen the matching editor; the two formats are not interchangeable', 'On Slides, Background from Studio or Background from Design can set a slide photo from either editor'] },
