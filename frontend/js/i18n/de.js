...
export default {
  ...
  'power.off_from': 'Bildschirm aus um',
  'power.on_at': 'Wieder an um',
  'power.add_window': 'Zeitraum hinzufügen',
  'power.remove_window': 'Diesen Zeitraum entfernen',
  'power.remove_schedule': 'Zeitplan entfernen',
  'power.save': 'Zeitplan speichern',
  'power.no_windows': 'Noch keine Zeiten festgelegt – der Bildschirm bleibt an.',
  'power.no_days': 'keine Tage',
  'power.overnight': '(über Nacht)',
  'power.crosses_midnight': 'Dieser Zeitraum läuft über Mitternacht bis zum nächsten Morgen.',
  'power.unsupported': 'Einige Bildschirme können sich nicht selbst abschalten und ignorieren diesen Zeitplan. Sie können ihn trotzdem speichern.',
  'power.inherited_from_group': 'Dieser Bildschirm folgt dem Zeitplan seiner Gruppe. Speichern überschreibt ihn nur für diesen Bildschirm.',
  'power.state.on': 'Bildschirm an',
  'power.state.scheduled_off': 'Planmäßig aus',
  'power.next_off': 'Geht um {time} aus',
  'power.next_on': 'Geht um {time} wieder an',
  'power.preset.weeknights': 'Wochentags 22:00–06:00',
  'power.preset.everynight': 'Jede Nacht 22:00–06:00',
  'power.preset.weekends': 'Das ganze Wochenende',
  'power.saved': 'Zeitplan gespeichert',
  'power.save_failed': 'Zeitplan konnte nicht gespeichert werden',
  'power.day.sun': 'So',
  'power.day.mon': 'Mo',
  'power.day.tue': 'Di',
  'power.day.wed': 'Mi',
  ...
  'slides.ai.generate': 'Erzeugen',
  'slides.ai.settings': 'KI-Einstellungen',
  ...
  'switcher.create_hint': 'Ein Arbeitsbereich ist ein eigener Satz von Bildschirmen, Playlists und Medien in Ihrer Organisation. Mitglieder werden pro Arbeitsbereich eingeladen.',
  'switcher.create_name_label': 'Name',
  'switcher.create_name_placeholder': 'z. B. Verkaufsflaeche',
  'switcher.create_slug_label': 'Slug (optional, URL-tauglich)',
  'switcher.create_slug_hint': 'Kleinbuchstaben, Ziffern, Bindestriche. Muss in der Organisation eindeutig sein.',
  'switcher.create_submit': 'Arbeitsbereich erstellen',
  'switcher.create_working': 'Wird erstellt...',
  'switcher.create_name_required': 'Name darf nicht leer sein',
  'switcher.create_failed': 'Arbeitsbereich konnte nicht erstellt werden',
  ...
  'dashboard.select_all': 'Alle', 'dashboard.invert_selection': 'Umkehren', 'dashboard.cancel_selection': 'Abbrechen', 'dashboard.remove_from_group': 'Aus Gruppe entfernen', 'dashboard.add_to_group': 'Zur Gruppe hinzufügen', 'dashboard.create_group_and_add': 'Gruppe erstellen und hinzufügen',
  ...
  'data_sources.title': 'Datenquellen & Integrationen',
  ...
  'data_sources.empty_desc': 'Verbinden Sie einen iCal/Webcal-Kalenderlink aus Google Kalender, Outlook, Apple Kalender oder einem beliebigen öffentlichen iCal-Feed. Binden Sie Raumstatus, den nächsten Termin oder den Abfallkalender an eine Folie — oder starten Sie unter Folien → Neue Präsentation → Türschild / Konferenzraum, Abfallkalender oder Tägliche Büro-Agenda.',
  ...
  'data_sources.synced_ok': 'Datenquelle erfolgreich synchronisiert',
  'data_sources.created_ok': 'Datenquelle erstellt und synchronisiert',
  'data_sources.failed_load': 'Fehler beim Laden der Datenquellen',
  'data_sources.deleted_ok': 'Datenquelle gelöscht',
  'data_sources.edit_title': 'Datenquelle bearbeiten',
  'data_sources.create_title': 'Neue Datenquelle anbinden',
  'data_sources.integration_type': 'Integrations-Typ',
  'data_sources.type_ical': '📅 iCalendar / Webcal (.ics)',
  'data_sources.type_api_soon': '🌐 REST API (JSON) — Demnächst',
  'data_sources.type_sheets_soon': '📊 Google Sheets — Demnächst',
  'data_sources.name_label': 'Name *',
  'data_sources.name_placeholder': 'z. B. Konferenzraum Berlin',
  'data_sources.slug_label': 'Kennung / Slug',
  'data_sources.slug_placeholder': 'z. B. room_berlin',
  'data_sources.slug_hint': 'Verwendung in Vorlagen: {{ds:slug.feld}}',
  'data_sources.url_label': 'iCalendar / Webcal URL *',
  'data_sources.url_placeholder': 'https://calendar.google.com/.../basic.ics oder webcal://...',
  'data_sources.url_hint': 'Öffentlicher oder geheimer iCal/ICS-Link aus Google Kalender, Outlook, Nextcloud, iCloud etc.',
  'data_sources.advanced_options': '⚙️ Erweiterte Optionen (Filter, Zeitzone, Privatsphäre)',
  'data_sources.interval_label': 'Aktualisierungsintervall',
  'data_sources.interval_1min': 'Jede Minute',
  'data_sources.interval_5min': 'Alle 5 Minuten (Empfohlen)',
  'data_sources.interval_15min': 'Alle 15 Minuten',
  'data_sources.interval_1hr': 'Jede Stunde',
  'data_sources.lookahead_label': 'Vorschau-Zeitraum (Tage)',
  'data_sources.filter_include_label': 'Einschluss-Filter (Suchbegriff)',
  'data_sources.filter_include_placeholder': 'z. B. Gelber Sack, Meeting',
  'data_sources.filter_exclude_label': 'Ausschluss-Filter (Suchbegriff)',
  'data_sources.filter_exclude_placeholder': 'z. B. Abgesagt, Privat',
  'data_sources.language_label': 'Sprache für Statusanzeige',
  'data_sources.language_de': 'Deutsch (Frei / Belegt)',
  'data_sources.language_en': 'Englisch (Available / Busy)',
  'data_sources.timezone_label': 'Zeitzone',
  'data_sources.privacy_label': '🔒 Privatsphäre-Modus: Termintitel & Beschreibungen verbergen (zeigt nur „Belegt“)',
  'data_sources.test_btn': '🧪 Verbindung testen & Live-Vorschau',
  'data_sources.testing': 'Verbindung wird getestet...',
  'data_sources.test_url_required': 'Bitte geben Sie zuerst eine iCal-URL ein.',
  'data_sources.test_success': '✅ Verbindung erfolgreich! {n} anstehende Termine gefunden.',
  'data_sources.test_failed': '❌ Verbindung fehlgeschlagen: {err}',
  'data_sources.source_label': 'Quelle:',
  'data_sources.last_sync_label': 'Zuletzt aktualisiert:',
  'data_sources.never_synced': 'Nie',
  'data_sources.inline_data': 'Direkte Daten',
  'data_sources.click_tag_copy': 'Klicken Sie auf ein Tag, um es in die Folie einzufügen:',
  'data_sources.fill_required': 'Bitte füllen Sie Name und iCal-URL aus.',
  'data_sources.saving': 'Wird gespeichert...',
  'data_sources.tag_copied': 'In die Zwischenablage kopiert!',
  'data_sources.status_frei': 'Status (FREI / BELEGT)',
  'data_sources.status_detail_label': 'Status-Details (z. B. Frei bis 14:00)',
  'data_sources.current_event_label': 'Aktuelles Meeting / Event',
  'data_sources.next_event_label': 'Nächstes Meeting / Event',
  'data_sources.next_time_label': 'Uhrzeit nächstes Event',
  'data_sources.agenda_text_label': 'Tages-Agenda (Mehrzeilig)',
  'data_sources.event_1_title_label': 'Termin 1 Titel',
  'data_sources.event_1_time_label': 'Termin 1 Uhrzeit',
  'data_sources.event_2_title_label': 'Termin 2 Titel',
  'data_sources.event_2_time_label': 'Termin 2 Uhrzeit',
  'slides.template_modal_title': 'Neues Foliendeck erstellen',
  'slides.deck_name_label': 'Deck-Name',
  'slides.deck_name_placeholder': 'z. B. Konferenzraum 1 oder Aktionsfolien',
  'slides.choose_template': 'Vorlage auswählen',
  'slides.tpl_blank_title': '✨ Leeres Foliendeck',
  'slides.tpl_blank_desc': 'Mit einer leeren Titelfolie starten (16:9).',
  'slides.tpl_room_title': '📅 Türschild / Konferenzraum (E-Paper 800×480)',
  'slides.tpl_room_desc': 'Optimiert für Seeed Studio reTerminal Sticky mit Live-Status FREI/BELEGT.',
  'slides.tpl_waste_title': '🗑️ Abfallkalender / Müllabfuhr-Erinnerung',
  'slides.tpl_waste_desc': 'Zeigt die nächste Abholung und das Datum aus Kalenderdaten an.',
  'slides.create_deck_btn': 'Deck erstellen',
  'slides.factory.continue': 'Weiter',
  'slides.factory.back': 'Zurück',
  'slides.factory.pick_source': 'Kalender',
  'slides.factory.no_source': 'In diesem Arbeitsbereich sind noch keine Datenquellen verbunden.',
  'slides.factory.connect_first': 'Zuerst einen Kalender verbinden',
  'slides.factory.create_placeholder': 'Mit Platzhalter „{slug}“ erstellen',
  'slides.factory.need_source': 'Wählen Sie einen Kalender zum Binden.',
  'slides.factory.room_title_label': 'Raumname auf dem Schild',
  'slides.factory.next_prefix': 'Nächstes Meeting',
  'slides.factory.now_prefix': 'Jetzt',
  'slides.factory.waste_headline': 'Nächste Abholung',
  'slides.factory.waste_note': 'Bitte die Tonne bis 06:00 bereitstellen.',
  'slides.factory.then_prefix': 'Danach',
  'slides.factory.include_hint': 'Richten Sie dies auf einen Kalender, der nur Abholtermine enthält, oder setzen Sie den Include-Filter auf Restmüll / Gelber Sack / Papier.',
  'slides.factory.aspect_hint_epaper': '800×480 E-Paper',
  'slides.factory.aspect_hint_lcd': '16:9 TV',
  'slides.factory.aspect_hint_portrait': 'Hochformat-Tablet 9:16',
  'slides.factory.board_hint': 'Jede Kachel ist ein Raumkalender.',
  'slides.factory.board_slot_1': 'Kalender 1',
  'slides.factory.board_slot_2': 'Kalender 2',
  'slides.factory.board_slot_3': 'Kalender 3',
  'slides.factory.board_slot_4': 'Kalender 4',
  'slides.factory.room_epaper_5x3.title': '📅 Türschild / Konferenzraum (E-Paper 800×480)',
  'slides.factory.room_epaper_5x3.desc': 'Schwarz-weisses Türschild für Seeed Sticky / Waveshare 7.5″. Live belegt / frei / veraltet aus dem Raumkalender.',
  'slides.factory.room_lcd_16x9.title': '📅 Türschild / Konferenzraum (TV 16:9)',
  'slides.factory.room_lcd_16x9.desc': 'Dunkles Tablet- oder kleines TV-Schild mit grünem / rotem / grauem Verfügbarkeitsbalken.',
  'slides.factory.room_lcd_9x16.title': '📅 Türschild / Konferenzraum (Tablet 9:16)',
  'slides.factory.room_lcd_9x16.desc': 'Hochformat-Türschild mit grünem / rotem / grauem Streifen oben. Gleicher belegt / frei / veraltet-Vertrag wie 16:9. Nicht für 1-bit E-Paper.',
  'slides.factory.rooms_board_16x9.title': '📅 Vier-Raum-Tafel (TV 16:9)',
  'slides.factory.rooms_board_16x9.desc': '2×2 Flurwand: vier Kalender, jede Kachel mit eigenem Verfügbarkeitsbalken. Nur Status — keine Buchung.',
  'slides.factory.waste_epaper_5x3.title': '🗑️ Abfallkalender / Müllabfuhr (E-Paper 800×480)',
  'slides.factory.waste_epaper_5x3.desc': 'Schwarz-weisses Küchenschild: nächste Tonne groß, Datum, Hinweis zum Bereitstellen, danach die folgende Abholung.',
  'slides.factory.waste_lcd_16x9.title': '🗑️ Abfallkalender / Müllabfuhr (TV 16:9)',
  'slides.factory.waste_lcd_16x9.desc': 'Dunkles Lobby- oder Küchen-TV-Schild mit der nächsten Abholung und der Woche. Optionale Fraktionsikone.',
  'slides.factory.board_title_label': 'Titel auf der Tafel',
  ...
  'slides.tab_motion': 'Animation',
  'slides.tab_slide': 'Folie',
  'slides.prompt_rename_slide': 'Folie umbenennen:',
  ...
  'dashboard.no_displays_desc': 'Installieren Sie die {brandName}-App auf Ihrem TV und koppeln Sie ihn mit dem obigen Button.',
  ...
  'studio.new_poster': 'Neues Poster',
  ...
  'studio.slide_bg_from_studio': 'Hintergrund aus Studio',
  'studio.slide_bg_help': 'Poster in Studio zeichnen; Veröffentlichen setzt es als Fotohintergrund dieser Folie (PNG in der Bibliothek).',
  'studio.slide_bg_applied': 'Studio-Hintergrund auf diese Folie angewendet — Deck speichern, wenn bereit',
  'studio.slide_bg_apply_failed': 'Studio-Hintergrund konnte nicht angewendet werden',
  'studio.pick_preset': 'Postergröße',
  'studio.pick_preset_help': 'Leinwandgröße wählen. In Studio vor dem ersten Veröffentlichen noch änderbar.',
  'studio.preset_landscape': '1920×1080 Querformat',
  'studio.preset_landscape_hint': 'TV / Lobby-Bildschirm',
  'studio.preset_portrait': '1080×1920 Hochformat',
  'studio.preset_portrait_hint': 'Stele / Tür-Tablet',
  'studio.preset_epaper': '800×480 E-Paper',
  'studio.preset_epaper_hint': 'Farb-PNG — das Panel dithered auf 1 Bit',
  'studio.open_editor': 'Poster-Editor öffnen',
  // Design-Editor (Suika-Insel, Phase 0+) — Button bleibt verborgen, bis /suika/ gebaut ist (I5).
  'design.name': 'Design-Editor',
  'design.new': 'Design erstellen',
  'design.help_blurb': 'Öffnet den Design-Editor in einem neuen Fenster. Zeichnen und mit „In Herald speichern“ ein PNG in die Bibliothek veröffentlichen. Das ist keine Folie — Uhren und Live-Daten bleiben bei Folien.',
  'design.unavailable': 'Design-Editor ist auf dieser Installation nicht verfügbar (Insel nicht gebaut).',
  'design.open_editor': 'Design-Editor öffnen',
  'design.popup_blocked': 'Erlauben Sie Pop-ups für diese Seite, sonst öffnet der Editor in diesem Tab.',
  'design.saved_toast': 'Design in der Bibliothek gespeichert',
  'design.save_failed': 'Design konnte nicht gespeichert werden',
  'design.edit': 'Design bearbeiten',
  'design.load_failed': 'Design konnte nicht zum Bearbeiten geladen werden',
  'design.wrong_editor': 'Dieses Element stammt aus dem Poster-Editor — nutzen Sie „Poster bearbeiten“',
  'design.pick_preset': 'Designgröße',
  'design.pick_preset_help': 'Leinwandgröße wählen, bevor der Design-Editor geöffnet wird.',
  'design.slide_bg_from_design': 'Hintergrund aus Design',
  'design.slide_bg_help': 'Im Design-Editor zeichnen; „In Herald speichern“ setzt es als Fotohintergrund dieser Folie (PNG in der Bibliothek).',
  'design.slide_bg_applied': 'Design-Hintergrund auf diese Folie angewendet — Deck speichern, wenn bereit',
  'design.slide_bg_apply_failed': 'Design-Hintergrund konnte nicht angewendet werden',
  ...
  'content.bundle_entry': 'Startet mit {entry}',
  'content.bundle_skipped': '{n} Datei(en) konnten nicht eingebettet werden — Video und Audio muessen verlinkt werden.',
  'content.bundle_preview_failed': 'Bundle konnte nicht gerendert werden',
  ...
  'settings.setup_step_1': 'Installieren Sie die {brandName} APK auf Ihrem TV via Sideloading',
  ...
  'settings.import.invalid_file': 'Ungültige Datei. Muss ein {brandName}-Export-JSON oder ZIP sein.',
  ...
  'widget.picker.upload': 'Bild hochladen',
  'widget.picker.drop_hint': 'Oder ziehen Sie ein Bild hierher.',
  'widget.picker.uploading': 'Wird hochgeladen…',
  'widget.picker.uploading_pct': 'Wird hochgeladen… {pct} %',
  'widget.picker.upload_failed': 'Upload fehlgeschlagen',
  'widget.picker.not_an_image': 'Hier können nur Bilddateien verwendet werden.',
  'widget.picker.no_images': 'Noch keine Bilder – laden Sie eines hoch oder ziehen Sie es hierher.',
  ...
  'onboarding.step.welcome.title': 'Willkommen bei {brandName}!',
  ...
  // --- 2.0.1: Einstiegs-Checkliste, Neuerungen ---
  'gs.playlist.cta_here': 'Inhalt hinzufügen',
  'gs.assign.desc': 'Öffne den Bildschirm, auf dem der Inhalt laufen soll, klicke auf Playlist, wähle dein Layout; wenn du nicht Vollbild verwendest, lege fest, wo der Inhalt abgespielt werden soll, und klicke auf Veröffentlichen.',
  'gs.assign.cta_here': 'Playlist auswählen',
  'whatsnew.title': 'Neu in {version}',
  'whatsnew.dismiss': 'Schließen',
  'whatsnew.full_notes': 'Vollständige Hinweise',
  'whatsnew.history_title': 'Neuerungen',
  'whatsnew.version_line': '{version} — {date}',
  'whatsnew.version_current': '{version} — {date} (läuft aktuell)',
  'onboarding.step.done.assign_label': 'Was soll auf diesem Bildschirm laufen?',
  'onboarding.step.done.assign_none': 'Noch nichts',
  'onboarding.toast.playlist_assigned': 'Playlist zugewiesen',
  'onboarding.toast.assign_failed': 'Diese Playlist konnte nicht zugewiesen werden',
  'onboarding.toast.publish_failed': 'Die Playlist konnte nicht veröffentlicht werden, daher würde noch nichts abgespielt',
};
