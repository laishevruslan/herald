...
export default {
  ...
  'content.upload_resume_prompt': 'Resume uploading {name}? {done}% was already sent last time.',
  ...
  'playlist.folders_empty_hidden': '{n} empty folders hidden',
  'playlist.folder_label': 'Filter by folder',
  'playlist.folder_all': 'All folders',
  'playlist.folder_root': 'No folder',
  'playlist.more_matches': '{n} more match — narrow the search or pick a folder',
  'playlist.library_truncated': 'This library is very large, so not all of it is listed here. Use the search or a folder to find an item.',
  ...
  'slides.ai.generate': 'Generate',
  'slides.ai.settings': 'AI settings',
  ...
  'switcher.create_hint': 'A workspace is a separate set of screens, playlists and media inside your organization. Members are invited per workspace.',
  'switcher.create_name_label': 'Name',
  'switcher.create_name_placeholder': 'e.g. Retail Floor',
  'switcher.create_slug_label': 'Slug (optional, URL-safe)',
  'switcher.create_slug_hint': 'Lowercase letters, digits, hyphens. Must be unique within the organization.',
  'switcher.create_submit': 'Create workspace',
  'switcher.create_working': 'Creating...',
  'switcher.create_name_required': 'Name cannot be empty',
  'switcher.create_failed': 'Could not create the workspace',
  ...
  'dashboard.add_to_group': 'Add to group',
  'dashboard.create_group_and_add': 'Create and add to group',
  'dashboard.remove_from_group': 'Remove from group',
  'dashboard.cancel_selection': 'Cancel',
  'dashboard.create_wall': 'Create Video Wall',
  'dashboard.selection_count_other': '{n} displays selected',
  ...
  'nav.reviews': 'Reviews',
  'data_sources.title': 'Data Sources & Integrations',
  ...
  'data_sources.synced_ok': 'Data source synced successfully',
  'data_sources.created_ok': 'Data source created and synced',
  'data_sources.failed_load': 'Failed to load data sources',
  'data_sources.deleted_ok': 'Data source deleted',
  'data_sources.edit_title': 'Edit Data Source',
  'data_sources.create_title': 'Connect New Data Source',
  'data_sources.integration_type': 'Integration Type',
  'data_sources.type_ical': '📅 iCalendar / Webcal (.ics)',
  'data_sources.type_api_soon': '🌐 REST API (JSON) — Coming Soon',
  'data_sources.type_sheets_soon': '📊 Google Sheets — Coming Soon',
  'data_sources.name_label': 'Name *',
  'data_sources.name_placeholder': 'e.g. Conference Room Berlin',
  'data_sources.slug_label': 'Identifier Slug',
  'data_sources.slug_placeholder': 'e.g. room_berlin',
  'data_sources.slug_hint': 'Used in templates: {{ds:slug.field}}',
  'data_sources.url_label': 'iCalendar / Webcal URL *',
  'data_sources.url_placeholder': 'https://calendar.google.com/.../basic.ics or webcal://...',
  'data_sources.url_hint': 'Public or secret iCal/ICS link from Google Calendar, Outlook, Nextcloud, iCloud, etc.',
  'data_sources.advanced_options': '⚙️ Advanced Options (Filtering, Timezone, Privacy)',
  'data_sources.interval_label': 'Sync Interval',
  'data_sources.interval_1min': 'Every 1 Minute',
  'data_sources.interval_5min': 'Every 5 Minutes (Recommended)',
  'data_sources.interval_15min': 'Every 15 Minutes',
  'data_sources.interval_1hr': 'Every 1 Hour',
  'data_sources.lookahead_label': 'Lookahead (Days)',
  'data_sources.filter_include_label': 'Include Filter (Keyword)',
  'data_sources.filter_include_placeholder': 'e.g. Meeting, Recycling',
  'data_sources.filter_exclude_label': 'Exclude Filter (Keyword)',
  'data_sources.filter_exclude_placeholder': 'e.g. Cancelled, Private',
  'data_sources.language_label': 'Language for Status Display',
  'data_sources.language_de': 'German (Frei / Belegt)',
  'data_sources.language_en': 'English (Available / Busy)',
  'data_sources.timezone_label': 'Timezone',
  'data_sources.privacy_label': '🔒 Privacy Mode: Hide meeting titles & descriptions on screen (shows only "Busy")',
  'data_sources.test_btn': '🧪 Test Connection & Preview Live Data',
  'data_sources.testing': 'Testing connection...',
  'data_sources.test_url_required': 'Please enter an iCal URL first.',
  'data_sources.test_success': '✅ Connection successful! Found {n} upcoming events.',
  'data_sources.test_plugin_ok': '✅ Connection successful. Preview of flattened fields:',
  'data_sources.test_failed': '❌ Connection failed: {err}',
  'data_sources.source_label': 'Source:',
  'data_sources.last_sync_label': 'Last sync:',
  'data_sources.never_synced': 'Never',
  'data_sources.inline_data': 'Inline Data',
  'data_sources.click_tag_copy': 'Click tag to copy into your Slide Template:',
  'data_sources.fill_required': 'Please fill in both Name and iCal URL.',
  'data_sources.saving': 'Saving...',
  'data_sources.tag_copied': 'Copied to clipboard!',
  'data_sources.status_frei': 'Status (AVAILABLE / BUSY)',
  'data_sources.status_detail_label': 'Status Details (e.g. Free until 14:00)',
  'data_sources.current_event_label': 'Current Meeting / Event',
  'data_sources.next_event_label': 'Next Meeting / Event',
  'data_sources.next_time_label': 'Next Event Time',
  'data_sources.agenda_text_label': 'Daily Agenda (Multi-line)',
  'data_sources.event_1_title_label': 'Event 1 Title',
  'data_sources.event_1_time_label': 'Event 1 Time',
  'data_sources.event_2_title_label': 'Event 2 Title',
  'data_sources.event_2_time_label': 'Event 2 Time',
  'data_sources.remaining_today_empty_label': 'No more meetings today (empty-board hint)',
  'data_sources.remaining_today_count_label': 'Remaining events today (count)',
  'data_sources.confirm_delete': 'Delete data source "{name}"?',
  'slides.template_modal_title': 'Create New Slide Deck',
  'slides.all_decks': 'All Decks',
  'slides.deck_name_label': 'Deck Name',
  'slides.deck_name_placeholder': 'e.g. Conference Room 1 or Promo Slides',
  'slides.choose_template': 'Choose Template',
  'slides.tpl_blank_title': '✨ Blank Slide Deck',
  'slides.tpl_blank_desc': 'Start from scratch with a clean title slide (16:9).',
  'slides.tpl_room_title': '📅 Meeting Room Door Sign (E-Paper 800×480)',
  'slides.tpl_room_desc': 'Optimized for Seeed Studio reTerminal Sticky with live FREI/BELEGT status.',
  'slides.tpl_waste_title': '🗑️ Waste Collection Reminder',
  'slides.tpl_waste_desc': 'Displays upcoming trash pickup and date from calendar data.',
  'slides.create_deck_btn': 'Create Deck',
  'slides.factory.continue': 'Continue',
  'slides.factory.back': 'Back',
  'slides.factory.pick_source': 'Calendar',
  'slides.factory.no_source': 'No data sources in this workspace yet.',
  'slides.factory.connect_first': 'Connect a calendar first',
  'slides.factory.create_placeholder': 'Create with placeholder “{slug}”',
  'slides.factory.need_source': 'Pick a calendar to bind.',
  'slides.factory.room_title_label': 'Room name on the sign',
  ...
  'slides.factory.include_hint': 'Point this at a calendar that only has collection events, or set an Include filter to Restmüll / Gelber Sack / Papier.',
  'slides.factory.aspect_hint_epaper': '800×480 e-paper',
  'slides.factory.aspect_hint_lcd': '16:9 TV',
  'slides.factory.aspect_hint_portrait': 'Portrait tablet 9:16',
  'slides.factory.board_hint': 'Each tile is one room calendar.',
  'slides.factory.board_slot_1': 'Calendar 1',
  'slides.factory.board_slot_2': 'Calendar 2',
  'slides.factory.board_slot_3': 'Calendar 3',
  'slides.factory.board_slot_4': 'Calendar 4',
  'slides.factory.room_epaper_5x3.title': '📅 Meeting Room Door Sign (E-Paper 800×480)',
  'slides.factory.room_epaper_5x3.desc': 'Black and white door sign for Seeed Sticky / Waveshare 7.5″. Live busy / free / stale from a room calendar.',
  'slides.factory.room_lcd_16x9.title': '📅 Meeting Room Door Sign (TV 16:9)',
  'slides.factory.room_lcd_16x9.desc': 'Dark tablet or small-TV sign with a green / red / grey availability bar.',
  'slides.factory.room_lcd_9x16.title': '📅 Meeting Room Door Sign (tablet 9:16)',
  'slides.factory.room_lcd_9x16.desc': 'Portrait door tablet with a green / red / grey strip on top. Same busy / free / stale contract as the 16:9 sign. Not for 1-bit e-paper.',
  'slides.factory.rooms_board_16x9.title': '📅 Four-room corridor board (TV 16:9)',
  'slides.factory.rooms_board_16x9.desc': '2×2 lobby wall: four calendars, each tile with its own availability bar. Status only — no booking.',
  'slides.factory.waste_epaper_5x3.title': '🗑️ Waste Collection Reminder (E-Paper 800×480)',
  'slides.factory.waste_epaper_5x3.desc': 'Black and white kitchen sign: next bag huge, date, put-the-bin-out note, then the following collection.',
  'slides.factory.waste_lcd_16x9.title': '🗑️ Waste Collection Reminder (TV 16:9)',
  'slides.factory.waste_lcd_16x9.desc': 'Dark lobby or kitchen-TV board with the next collection and a week of pickups. Optional fraction icon.',
  'slides.factory.board_title_label': 'Title on the board',
  'slides.factory.agenda_headline': 'Today',
  'slides.factory.agenda_lcd_16x9.title': '📋 Daily Office Agenda (TV 16:9)',
  'slides.factory.agenda_lcd_16x9.desc': 'Lobby or tea-point board: live date, eight timed rows, and “no more meetings today” when the calendar is empty this evening. Same layout on 4K.',
  'slides.factory.chip.all': 'All',
  'slides.factory.chip.room': 'Room',
  'slides.factory.chip.facilities': 'Facilities',
  'slides.factory.chip.agenda': 'Agenda',
  'slides.factory.chip.blank': 'Blank',
  'slides.insert_var': '⚡ Insert Variable...',
  'slides.tab_content': 'Content',
  'slides.tab_style': 'Style',
  'slides.tab_motion': 'Motion',
  'slides.tab_slide': 'Slide',
  'slides.prompt_rename_slide': 'Rename slide:',
  ...
  'dashboard.no_displays_desc': 'Install the {brandName} app on your TV and pair it using the button above.',
  ...
  'dashboard.talk_all': 'Talk to all',
  'dashboard.talk_group': 'Talk',
  'dashboard.talk.end': 'End',
  'dashboard.talk.on_air': 'On air — speaking to the group',
  'dashboard.talk.failed': 'Could not start the broadcast',
  'dashboard.talk.no_devices': 'No devices in scope could join the broadcast',
  ...
  'dashboard.cmd.set_server_url': 'Change server URL',
  'dashboard.set_server_url_prompt': 'New server URL for all {n} device(s) in "{group}". Each panel verifies it is reachable and only switches if so:',
  'dashboard.set_server_url_confirm': 'Point all {n} device(s) in "{group}" at {url}? Panels that cannot reach it keep their current server.',
  'dashboard.ws_set_server_url': 'Move to a new server',
  'dashboard.ws_set_server_url_tip': 'Point every device in this workspace at a new server address (a server move). Admins only. Each panel verifies the address is reachable before switching.',
  'dashboard.ws_set_server_url_no_ws': 'Switch to a workspace first.',
  'moveserver.title': 'Move to a new server',
  'moveserver.warning': '<strong>Warning:</strong> this tells all {n} device(s) in "{workspace}" to switch to a new server address. Each panel checks the new address is reachable before switching and keeps its current server if it cannot reach it, but a wrong-yet-reachable address would point the whole workspace at the wrong server. Only continue for a planned server move.',
  'moveserver.url_label': 'New server URL',
  'moveserver.url_bad': 'Enter a full http:// or https:// URL.',
  'moveserver.type_label': 'Type the workspace name ({name}) to confirm',
  'moveserver.confirm_btn': 'Move devices',
  'moveserver.sending': 'Sending…',
  'moveserver.failed': 'Could not send the move command.',
  ...
  'dashboard.toast.added_to_group_one': 'Added 1 display to the group',
  'dashboard.toast.added_to_group_other': 'Added {n} displays to the group',
  'dashboard.toast.removed_from_group_one': 'Removed 1 display from the group',
  'dashboard.toast.removed_from_group_other': 'Removed {n} displays from the group',
  ...
  'content.upload_hint': 'Supports MP4, WebM, AVI, MKV, JPEG, PNG, GIF, WebP, MP3, M4A, WAV, OGG, FLAC. A PDF becomes one image per page, in a folder and a playlist of its own.',
  'content.pdf.rendering': 'Rendering {name}: page {done} of {total}',
  'content.pdf.uploading': '{name}: uploading pages — {pct}%',
  'content.pdf.playlist_description': 'The pages of {name}, {count} in total. Made from the PDF upload.',
  'content.toast.pdf_imported': '{name}: {count} pages added to a folder and a playlist of the same name',
  'content.toast.pdf_playlist_failed': '{name}: {count} pages were uploaded, but the playlist could not be created: {error}',
  ...
  'content.filter_type_live': 'Live streams',
  'content.filter_type_bundle': 'HTML bundle',
  'content.type_bundle': 'HTML bundle',
  'content.type_bundle_short': 'Bundle',
  'content.bundle_entry': 'Starts at {entry}',
  'content.bundle_skipped': '{n} file(s) could not be inlined - video and audio have to be linked, not embedded.',
  'content.bundle_preview_failed': 'Could not render that bundle',
  ...
  // Studio poster editor (phase 6) — button stays hidden until /studio/ is built (I5).
  'studio.name': 'Poster editor',
  'studio.new_poster': 'New poster',
  ...
  'studio.slide_bg_from_studio': 'Background from Studio',
  'studio.slide_bg_help': 'Draw a poster in Studio; publish sets it as this slide’s photo background (PNG in the library).',
  'studio.slide_bg_applied': 'Studio background applied to this slide — save the deck when ready',
  'studio.slide_bg_apply_failed': 'Could not apply the Studio background',
  'studio.pick_preset': 'Poster size',
  'studio.pick_preset_help': 'Choose the canvas size. You can still change it in Studio before the first publish.',
  'studio.preset_landscape': '1920×1080 landscape',
  'studio.preset_landscape_hint': 'TV / lobby screen',
  'studio.preset_portrait': '1080×1920 portrait',
  'studio.preset_portrait_hint': 'Totem / door tablet',
  'studio.preset_epaper': '800×480 e-paper',
  'studio.preset_epaper_hint': 'Colour PNG — the panel will dither to 1-bit',
  'studio.open_editor': 'Open poster editor',
  // Design editor (Suika island, Phase 0+) — button stays hidden until /suika/ is built (I5).
  'design.name': 'Design editor',
  'design.new': 'Create design',
  'design.help_blurb': 'Open the design editor in a new window. Draw a poster, then Save to Herald to publish a PNG to the library. This is not a slide — clocks and live data stay in Slides.',
  'design.unavailable': 'Design editor is not available on this install (island not built).',
  'design.open_editor': 'Open design editor',
  'design.popup_blocked': 'Allow pop-ups for this site, or the editor will open in this tab.',
  'design.saved_toast': 'Design saved to the library',
  'design.save_failed': 'Could not save the design',
  'design.edit': 'Edit design',
  'design.load_failed': 'Could not load the design for editing',
  'design.wrong_editor': 'This item was made in the poster editor — use Edit poster instead',
  'design.pick_preset': 'Design size',
  'design.pick_preset_help': 'Choose the canvas size before opening the design editor.',
  'design.slide_bg_from_design': 'Background from Design',
  'design.slide_bg_help': 'Draw in the design editor; Save to Herald sets it as this slide’s photo background (PNG in the library).',
  'design.slide_bg_applied': 'Design background applied to this slide — save the deck when ready',
  'design.slide_bg_apply_failed': 'Could not apply the design background',
  ...
  'content.tags_placeholder': 'promo, lobby, spanish',
  'content.tags_hint': 'Comma-separated labels. A playlist can skip unless an item has (or lacks) a tag. Copied onto the published snapshot so screens still skip offline.',
  'content.label_meta': 'Metadata',
  'content.meta_placeholder': 'dept=sales\nlanguage=en',
  ...
  'content.error_enter_hls_url': 'Enter a live stream (.m3u8) URL',
  ...
  'device.owner_provision.constraints': 'Requires a freshly set-up / factory-reset device with no accounts, done before other device-owner apps enroll. If an MDM already owns the device, {brandName} stays at Tier 0/1 and the MDM owns updates.',
  ...
  'device.terminal.welcome': '{brandName} shell — runs as the app UID (not root). Type a command or tap a preset.',
  ...
  'device.ctl.set_server_url': 'Change server URL',
  'device.ctl.set_server_url_tip': 'Point this device at a different server address. It verifies the new address is reachable before switching, and keeps the current one if not.',
  'device.ctl.set_server_url_prompt': 'New server URL for this device. It verifies the address is reachable and only switches if so:',
  'device.ctl.set_server_url_bad': 'Enter a full http:// or https:// URL.',
  'device.ctl.set_server_url_confirm': 'Point this device at {url}? It keeps the current server if the new one is unreachable.',
  'device.ctl.set_server_url_dispatched': 'Sent. The device will switch to {url} once it confirms the address is reachable.',
  // Remote tab
  ...
  'device.talk.start': 'Talk',
  'device.talk.two_way': '2-way audio',
  ...
  'device.remote.capture_view': 'This panel is only showing the player\u2019s own window — anything else on the device appears blank. Press the button above to restore the full screen, or enable the ScreenTinker accessibility service on the device, which also survives updates.',
  ...
  'support.desc': 'Let ScreenTinker support into this instance for a limited time, only when you ask. Generate a request code and send it to support; the token they sign against it opens a single, time-boxed session that you can see here and end at any moment. Support sessions cannot manage users, billing or delete anything.',
  ...
  'support.request_expires': 'Expires in {hours} hours, or when a support token is redeemed against it — whichever comes first.',
  'support.copy': 'Copy',
  'support.toast_copied': 'Request code copied',
  'support.sessions_title': 'Active support sessions',
  'support.no_sessions': 'No support sessions are open on this instance.',
  'support.requests_title': 'Open support requests',
  'support.col_org': 'Organisation',
  'support.col_reason': 'Reason',
  'support.col_first_used': 'First used',
  'support.col_expires': 'Expires',
  'support.col_code': 'Code',
  'support.col_requested_by': 'Requested by',
  'support.not_yet_used': 'not yet used',
  'support.revoke': 'End session',
  'support.cancel_request': 'Withdraw',
  'support.toast_revoked': 'Support session ended',
  'support.issue_title': 'Issue a support token',
  'support.issue_desc': 'Paste the request code the customer sent you. The token only works on the instance that generated that code, once, for the hours below.',
  'support.issue_code': 'Customer request code',
  'support.issue_org': 'Customer',
  'support.issue_org_placeholder': 'Organisation name (shown to the customer)',
  'support.issue_hours': 'Hours',
  'support.issue_reason': 'Reason',
  'support.issue_reason_placeholder': 'Ticket # or what you are looking at',
  'support.issue_btn': 'Sign token',
  'support.issue_result': 'Support token — paste into the customer\'s login page under "Support Access":',
  'support.issue_code_required': 'The customer\'s request code is required',
  ...
  'settings.signin_err_link_already_used': 'That provider account is already linked to a different {brandName} account.',
  ...
  'settings.setup_step_1': 'Install the {brandName} APK on your TV via sideloading',
  ...
  'settings.import.invalid_file': 'Invalid file. Must be a {brandName} export JSON or ZIP.',
  ...
  'widget.field.use_dashboard_timezone': 'Use dashboard timezone',
  'widget.field.use_server_timezone': 'Use server timezone',
  'widget.field.show_seconds': 'Show seconds',
  'widget.field.show_date': 'Show date',
  'widget.field.date_format': 'Date format',
  'widget.field.date_format_full': 'Full — Wednesday, September 3, 2026',
  'widget.field.date_format_long': 'Long — September 3, 2026',
  'widget.field.date_format_medium': 'Medium — Sep 3, 2026',
  'widget.field.date_format_short': 'Short — 09/03/26',
  'widget.field.date_position': 'Date position',
  'widget.field.date_position_below': 'Below time',
  'widget.field.date_position_above': 'Above time',
  'widget.field.date_position_left': 'Left of time',
  'widget.field.date_position_right': 'Right of time',
  'widget.field.date_font_size_px': 'Date size (px)',
  'widget.field.date_color': 'Date color',
  'widget.field.locale': 'Language for dates and times',
  'widget.field.locale_hint': 'BCP-47 tag, e.g. es-ES. Leave blank to use the screen\u2019s own language.',
  'widget.field.layout': 'Layout',
  'widget.field.layout_vertical': 'Stacked',
  'widget.field.layout_horizontal': 'Side by side',
  'widget.field.show_location': 'Show the city name',
  'widget.field.weather_locale_hint': 'Two-letter code, e.g. es. Blank keeps the provider default (English).',
  ...
  'widget.picker.upload': 'Upload image',
  'widget.picker.drop_hint': 'Or drop an image here to upload it.',
  'widget.picker.uploading': 'Uploading…',
  'widget.picker.uploading_pct': 'Uploading… {pct}%',
  'widget.picker.upload_failed': 'Upload failed',
  'widget.picker.not_an_image': 'Only image files can be used here.',
  'widget.picker.no_images': 'No images yet — use Upload image, or drop one here.',
  ...
  'playlist.dwell': 'Dwell',
  'playlist.dwell_hint': 'How long to stay on this live channel, in seconds. 0 = stay until the item is skipped (schedule, disabled, or a condition).',
  'playlist.weight': 'Weight',
  'playlist.sec': 'sec',
  'playlist.play_from': 'From',
  'playlist.play_until': 'To',
  'playlist.play_window_hint': 'Optional. The screen skips this item outside this window. Times are the screen\'s local time. Empty means always in the loop. Publish to push to devices.',
  'playlist.select_all': 'Select all',
  'playlist.selected': '{n} selected',
  'playlist.bulk.copy': 'Copy',
  'playlist.bulk.cut': 'Cut',
  'playlist.bulk.paste': 'Paste',
  'playlist.bulk.delete': 'Delete',
  'playlist.bulk.duplicate': 'Duplicate',
  'playlist.bulk.duration': 'Duration',
  'playlist.bulk.weight': 'Weight',
  'playlist.bulk.window': 'From / to',
  'playlist.bulk.validity': 'Days & hours',
  'playlist.bulk.activate': 'Activate',
  'playlist.bulk.deactivate': 'Deactivate',
  'playlist.bulk.log_on': 'Log plays',
  'playlist.bulk.log_off': 'Don\'t log',
  'playlist.bulk.fit': 'Fit',
  'playlist.bulk.fit_inherit': 'Layout',
  'playlist.bulk.fit_contain': 'Fit',
  'playlist.bulk.fit_cover': 'Fill',
  'playlist.bulk.fit_fill': 'Stretch',
  'playlist.bulk.transition': 'Transition',
  'playlist.bulk.condition': 'If data…',
  'playlist.bulk.apply': 'Apply',
  'playlist.bulk.copied': 'Copied {n} item(s)',
  'playlist.bulk.cut_done': 'Cut {n} item(s)',
  'playlist.bulk.pasted': 'Pasted {n} item(s)',
  'playlist.bulk.deleted': 'Deleted {n} item(s)',
  'playlist.bulk.updated': 'Updated {n} item(s)',
  'playlist.bulk.no_transition': 'No transition widgets in this workspace',
  'playlist.bulk.clip_failed': 'Could not copy to the clipboard, so nothing was cut',
  'playlist.bulk.deactivate_all_warn': 'This deactivates every item, so screens on this playlist will show nothing until you re-activate or add content. Continue?',
  'playlist.condition.slug': 'Data source slug',
  'playlist.condition.path': 'Field path',
  'playlist.condition.op': 'Compare',
  'playlist.condition.value': 'Value',
  'playlist.condition.clear': 'Clear condition',
  'playlist.condition.hint': 'Skip this item unless the condition matches. Data-source fields use the last fetched values. Tags and metadata come from the content. Missing data-source values play (fail open). Publish to push to devices.',
  'playlist.condition.no_sources': 'No data sources in this workspace yet. Add one under Data Sources first.',
  'playlist.condition.type': 'When',
  'playlist.condition.type_ds': 'Data source field',
  'playlist.condition.type_tag': 'Has / lacks a tag',
  'playlist.condition.type_meta': 'Metadata field',
  'playlist.condition.tag': 'Tag',
  'playlist.condition.tag_has': 'Has tag',
  'playlist.condition.tag_lacks': 'Lacks tag',
  ...
  'playlist.plays_through': 'plays in full',
  'playlist.nested_duration_hint': 'Every item in the included playlist plays, each for its own duration.',
  'playlist.nest_draft_note': 'not published yet',
  'playlist.no_playlists_nestable': 'No playlists can be added here. A playlist that already includes another one cannot be nested again — playlists go one level deep.',
  'playlist.nest_blocked_one': 'This playlist is already used inside another one, so it cannot include a playlist itself. Playlists go one level deep.',
  'playlist.nest_blocked_other': 'This playlist is already used inside {n} others, so it cannot include a playlist itself. Playlists go one level deep.',
  'playlist.used_by_one': 'used in 1',
  'playlist.used_by_other': 'used in {n}',
  'playlist.used_by_tip_one': 'Included in 1 other playlist. Remove it there before deleting it.',
  'playlist.used_by_tip_other': 'Included in {n} other playlists. Remove it there before deleting it.',
  'playlist.sort_label': 'Sort',
  'playlist.order_label': 'Order',
  ...
  'playlist.sort.name_desc': 'Name (Z-A)',
  'playlist.sort.date_desc': 'Newest first',
  'playlist.sort.date_asc': 'Oldest first',
  'playlist.sort.duration_asc': 'Shortest first',
  'playlist.sort.duration_desc': 'Longest first',
  'playlist.select_all_shown': 'Select all shown',
  'playlist.add_n_selected_one': 'Add 1 selected',
  'playlist.add_n_selected_other': 'Add {n} selected',
  'playlist.toast.bulk_added_one': '1 item added',
  'playlist.toast.bulk_added_other': '{n} items added',
  'playlist.toast.bulk_added_partial': '{added} added, {skipped} skipped (expired, deactivated, or no longer available)',
  'playlist.toast.sorted': 'Playlist reordered',
  ...
  'playlist.toast.window_saved': 'Play window saved. Publish the playlist to push it to devices.',
  'itemsched.publish_note': 'Saved here as a draft. Devices keep showing the published version until you Publish the playlist.',
  ...
  'itemsched.err.same': 'Start and end time must be different (a zero-length window never plays)',
  ...
  'onboarding.step.welcome.title': 'Welcome to {brandName}!',
  ...
  'admin.diag.title': 'Server diagnostics',
  'admin.diag.desc': 'What this server is doing right now, and what it has been doing. Counts and timings only — no playlist content, media or credentials.',
  'admin.diag.refresh': 'Refresh',
  'admin.diag.band': 'Event loop',
  'admin.diag.lag_daily': 'Event loop, by day',
  'admin.diag.shape': 'Instance shape',
  'admin.diag.no_history': 'No history recorded yet.',
  'admin.diag.profile': 'Take CPU profile',
  'admin.diag.profiling': 'Profiling {seconds}s…',
  'admin.diag.profiling_note': 'Sampling the running server. This takes as long as you asked for — leave the page open.',
  'admin.diag.profile_done': 'Profile captured',
  'admin.diag.top_self': 'Where the loop spent its time',
  'admin.diag.download': 'Download .cpuprofile',
  'admin.plugins.title': 'Plugins',
  'admin.plugins.desc': 'Drop a folder in DATA_DIR/plugins, or upload a zip below. Uploaded packages sit in quarantine until you approve that exact tree — they never run on upload. Enable + restart still required. Off unless PLUGINS_ENABLED is set.',
  'admin.plugins.empty': 'No plugins discovered yet. Upload a zip or copy a folder into plugins/. Refresh this page to see it.',
  'admin.plugins.col_name': 'Name',
  'admin.plugins.col_id': 'Id',
  'admin.plugins.col_origin': 'Origin',
  'admin.plugins.col_status': 'Status',
  'admin.plugins.col_hash': 'Allowlist',
  'admin.plugins.enable': 'Enable',
  'admin.plugins.disable': 'Disable',
  'admin.plugins.loaded': 'Loaded',
  'admin.plugins.enabled': 'Enabled — restart to load',
  'admin.plugins.disabled': 'Disabled',
  'admin.plugins.error': 'Error',
  'admin.plugins.restart': 'Enable and disable take effect after a restart. The running process never loads new plugin code without one. Approve is not enable.',
  'admin.plugins.restart_now': 'Saved. Restart the server to load or unload this plugin.',
  'admin.plugins.saved': 'Saved',
  'admin.plugins.failed': 'Could not update plugin',
  'admin.plugins.settings': 'Settings',
  'admin.plugins.settings_saved': 'Settings saved. They apply immediately — no restart.',
  'admin.plugins.save_settings': 'Save settings',
  'admin.plugins.upload': 'Upload a plugin zip',
  'admin.plugins.upload_cta': 'Queue for review',
  'admin.plugins.upload_hint': 'Must contain plugin.json and index.js. No node_modules, no package.json, no shell scripts. Max 2MB.',
  'admin.plugins.pending': 'Waiting for approval',
  'admin.plugins.pending_empty': 'No plugin zips waiting.',
  'admin.plugins.approve': 'Approve',
  'admin.plugins.reject': 'Reject',
  'admin.plugins.files': 'Files',
  'admin.plugins.submitted': 'Submitted',
  'admin.plugins.allowlist_title': 'Allowlist',
  'admin.plugins.allowlist_empty': 'Nothing pinned. Approved uploads and pinned drop-folder plugins appear here.',
  'admin.plugins.pin': 'Pin hash',
  'admin.plugins.unpin': 'Unpin',
  'admin.plugins.inspect': 'Inspect',
  'admin.plugins.queued': 'Queued. It will not run until you approve it, enable it, and restart.',
  'admin.plugins.approved_ok': 'Approved and copied into DATA_DIR/plugins. Enable it, then restart to load.',
  'admin.plugins.rejected_ok': 'Rejected. The zip was deleted.',
  'admin.plugins.pinned_ok': 'Pinned. A later edit on disk will refuse to load until you pin again.',
  'admin.plugins.approve_confirm': 'Approve this exact tree? It will be copied into DATA_DIR/plugins and pinned. It will not run until you enable it and restart.',
  'admin.plugins.replace_confirm': 'A plugin with this id is already installed. Replace it with this zip? Enable + restart still required.',
  'admin.plugins.unpin_upload_confirm': 'Unpin and delete the installed copy? It was uploaded, so it will not fall back to drop-folder trust.',
  'admin.plugins.manifest': 'plugin.json',
  'widget.plugin_submit.title': 'Submit a plugin',
  'widget.plugin_submit.desc': 'Upload a .zip for the operator to review. It will not run until they approve that exact tree, enable it, and restart.',
  'widget.plugin_submit.cta': 'Submit zip',
  'widget.plugin_submit.ok': 'Submitted. It is waiting for operator approval.',
  'widget.plugin_submit.pending': 'Waiting for approval',
  ...
  'admin.orgs.talk_enable': 'Enable Talk (voice intercom / PA) for this organization',
  'admin.orgs.talk_ice_label': 'Custom ICE servers (JSON array; blank = use the server default STUN/TURN):',
  'admin.orgs.talk_save': 'Save Talk settings',
  'admin.orgs.talk_saved': 'Talk settings saved',
  'admin.orgs.talk_save_failed': 'Failed to save Talk settings',
  ...
  'schedule.repeat_custom': 'Custom days…',
  'schedule.repeat_days': 'Repeat on',
  'schedule.repeat_until': 'Repeat until',
  'schedule.repeat_until_hint': 'Leave blank to repeat indefinitely.',
  'schedule.day_mo': 'Mon',
  'schedule.day_tu': 'Tue',
  'schedule.day_we': 'Wed',
  'schedule.day_th': 'Thu',
  ...
  'schedule.view_day': 'Day',
  'schedule.view_workweek': 'Work week',
  'schedule.view_week': 'Week',
  'schedule.view_month': 'Month',
  'schedule.today': 'Today',
  'schedule.prev': 'Previous',
  'schedule.next': 'Next',
  'schedule.new': 'New schedule',
  'schedule.rail_toggle': 'Show or hide the calendar list',
  'schedule.jump_to_date': 'Jump to a date',
  'schedule.calendars': 'Calendars',
  'schedule.calendars_screens': 'Screens',
  'schedule.calendars_groups': 'Groups',
  'schedule.search_calendars': 'Find a screen or group',
  'schedule.no_calendars': 'Nothing matches.',
  'schedule.all_day': 'All day',
  'schedule.more_count': '+{n} more',
  'schedule.day_flyout_title': 'Schedules on {date}',
  'schedule.day_flyout_empty': 'Nothing scheduled.',
  'schedule.peek_edit': 'Edit',
  'schedule.peek_delete': 'Delete',
  'schedule.peek_close': 'Close',
  'schedule.peek_open_day': 'Open day',
  'schedule.peek_items': 'Playlist items',
  'schedule.peek_item_always': 'always',
  'schedule.peek_open_playlist': 'Open playlist',
  'schedule.compose_title': 'New schedule',
  'schedule.compose_more': 'More details',
  'schedule.compose_save': 'Save',
  'schedule.compose_target': 'Screen or group',
  'schedule.compose_playlist': 'Playlist',
  'schedule.compose_date': 'On {date}',
  'schedule.series_prompt_title': 'Change a repeating schedule',
  'schedule.series_prompt_body': 'This schedule repeats. Apply the change to this occurrence only, or to the entire series?',
  'schedule.series_this': 'This occurrence',
  'schedule.series_all': 'Entire series',
  'schedule.repeat_monthly': 'Monthly, on the same date',
  'schedule.repeat_summary_none': 'Does not repeat.',
  'schedule.repeat_summary_daily': 'Every day',
  'schedule.repeat_summary_weekly': 'Every {days}',
  'schedule.repeat_summary_monthly': 'Monthly on day {d}',
  'schedule.repeat_summary_time': 'from {start} to {end}',
  'schedule.repeat_summary_until': 'until {date}',
  'schedule.recurring_no_day_move': 'A repeating schedule follows its rule, so it cannot be dragged to another day. Edit the repeat instead.',
  'schedule.toast.occurrence_saved': 'Saved for this occurrence only.',
  'schedule.keyboard_hint': 'T today · ← → move · N new · Esc close',
  'schedule.hidden_calendars_hint': 'Some calendars are hidden. Tick them in the list to show their schedules.',
  ...
  'dashboard.stats.title': 'Help show how widely {brandName} is deployed?',
  'dashboard.stats.body': 'Because most installs are private, we can\'t tell how many screens are out there. Sharing sends a random ID, the version, and how many screens you run — nothing else, ever. You can change this any time in Settings.',
  'dashboard.stats.share': 'Share',
  'dashboard.stats.no_thanks': 'No thanks',
  'dashboard.stats.thanks': 'Thank you — sharing install statistics',
  'settings.security': 'Security',
  'settings.widget_sandbox': 'Widget sandbox isolation',
  'settings.widget_sandbox_desc': 'Keep widget code in a null-origin sandbox. Turning this off allows widget code to run with same-origin access.',
  'settings.widget_sandbox_on': 'Isolation enabled',
  'settings.widget_sandbox_off': 'Isolation disabled',
  'settings.widget_sandbox_toast_on': 'Widget sandbox isolation enabled',
  'settings.widget_sandbox_toast_off': 'Widget sandbox isolation disabled',
  'settings.widget_sandbox_banner': 'Widget sandbox isolation is DISABLED. Widget code in this organization runs\nwith full access to user sessions. Re-enable in Settings > Security.',
  'settings.widget_sandbox_open': 'Open Settings',
  'settings.telemetry': 'Install statistics',
  'settings.telemetry_loading': 'Loading…',
  'settings.telemetry_unavailable': 'Unavailable.',
  'settings.telemetry_desc': '{brandName} can\'t see how widely it\'s deployed, because most installs are private by design. Sharing lets us say how many screens are running — nothing more.',
  'settings.telemetry_share': 'Share install statistics',
  'settings.telemetry_payload': 'Everything that would be sent, in full:',
  'settings.telemetry_when_on': 'Sent once a day to',
  'settings.telemetry_when_off': 'When enabled, sent once a day to',
  'settings.telemetry_firewall': 'If this server\'s outbound traffic is filtered, that address has to be allowed or the reports never arrive.',
  'settings.telemetry_extra': 'A second copy also goes to your own collector at {endpoint}, configured on this server with TELEMETRY_EXTRA_ENDPOINT. That is in addition to the above, not instead of it — turn the switch off if you want your own statistics without sharing.',
  'settings.telemetry_failed': 'The last attempt ({when}) did not get through — {why}. Check that outbound HTTPS to that address is permitted.',
  'settings.telemetry_fail_network': 'the connection was refused or the address did not resolve',
  'settings.telemetry_fail_timeout': 'the connection timed out',
  'settings.telemetry_fail_other': 'the server replied {reason}',
  'settings.telemetry_privacy': 'No names, addresses, content, or user details. The ID is random and identifies the install only so repeat reports aren\'t counted twice. {sent}',
  'settings.telemetry_last_sent': 'Last sent {when}.',
  'settings.telemetry_never_sent': 'Nothing has been sent yet.',
  'settings.telemetry_off': 'Install statistics off',
  'settings.telemetry_shared': 'Shared — thank you',
  'settings.telemetry_saved_fail': 'Saved, but the first report did not get through — see below',
  'settings.telemetry_save_err': 'Could not save that setting',

  // Slides list page
  'slides.page_subtitle': 'Build a deck of slides and publish it as a playlist.',
  'slides.new_deck': '+ New deck',
  'slides.empty_title': 'No decks yet',
  'slides.empty_desc': 'A deck is a set of slides that publishes as a playlist — headline, photo, big number, each with its own entrance.',
  'slides.loading': 'Loading…',
  'slides.load_failed': 'Could not load decks: {error}',
  'slides.slide_count_one': '{n} slide · {sec}s total',
  'slides.slide_count_other': '{n} slides · {sec}s total',

  // Activity alerts panel
  'activity.open_alerts': 'Open alerts',
  'activity.recent': 'Recent activity',
  'activity.nothing_open': 'Nothing is open right now.',
  'activity.nothing_open_mesh': 'Nothing is open right now, here or on any connected server.',
  'activity.check_connection': 'Check this server\'s connection first',
  'activity.this_server': 'this server',
  'activity.this_server_device': 'this server · {id}',
  'activity.stale_remote': ' · last known, that server is not reachable',
  'activity.loading': 'Loading…',

  // Layout template + zone seed names
  'layout.tpl.fullscreen': 'Fullscreen',
  'layout.tpl.split_h': 'Split Horizontal',
  'layout.tpl.split_v': 'Split Vertical',
  'layout.tpl.l_bar': 'L-Bar with Ticker',
  'layout.tpl.pip': 'Picture in Picture',
  'layout.tpl.thirds': 'Three Column',
  'layout.tpl.quad': 'Four Quadrants',
  'layout.tpl.p_full': 'Portrait Fullscreen',
  'layout.tpl.p_split': 'Portrait Split',
  'layout.tpl.p_ticker': 'Portrait with Ticker',
  'layout.tpl.p_banner': 'Portrait Banner + Body',
  'layout.tpl.p_thirds': 'Portrait Three Stacked',
  'layout.tpl.p_pip': 'Portrait Picture in Picture',
  'layout.zone.main': 'Main',
  'layout.zone.left': 'Left',
  'layout.zone.right': 'Right',
  'layout.zone.top': 'Top',
  'layout.zone.bottom': 'Bottom',
  'layout.zone.center': 'Center',
  'layout.zone.main_content': 'Main Content',
  'layout.zone.side_panel': 'Side Panel',
  'layout.zone.bottom_ticker': 'Bottom Ticker',
  'layout.zone.background': 'Background',
  'layout.zone.pip_window': 'PiP Window',
  'layout.zone.top_left': 'Top Left',
  'layout.zone.top_right': 'Top Right',
  'layout.zone.bottom_left': 'Bottom Left',
  'layout.zone.bottom_right': 'Bottom Right',
  'layout.zone.top_banner': 'Top Banner',
  'layout.zone.body': 'Body',
  'layout.zone.middle': 'Middle',

  // What's new note bodies (version.index) — English mirrors release-notes.json
  'whatsnew.note.2.1.4.0': 'Fixes a brief "Connecting" message that could appear over a multi-zone panel\'s zones for a few seconds right after a reboot (a follow-up to the 2.1.3 cold-start fix).',
  ...
  'help.shortcut_gallery_arrows': 'Move the selected New Deck card',
  'help.shortcut_gallery_enter': 'Continue from the gallery, or create when the deck name is focused',
  'help.guide.setup.title': 'Setting Up a Display',
  'help.guide.setup.s1': 'Download the APK or open the Web Player',
  'help.guide.setup.s2': 'Enter your server URL',
  'help.guide.setup.s3': 'Note the 6-digit pairing code',
  'help.guide.setup.s4': 'Click "Add Display" in the dashboard and enter the code',
  'help.guide.setup.s5': 'Assign content to the display\'s playlist',
  'help.guide.upload.title': 'Uploading Content',
  'help.guide.upload.s1': 'Go to Content Library',
  'help.guide.upload.s2': 'Drag and drop files or click the upload area',
  'help.guide.upload.s3': 'Supports MP4, WebM, JPEG, PNG, GIF, WebP',
  'help.guide.upload.s4': 'Videos auto-detect duration and generate thumbnails',
  'help.guide.upload.s5': 'Use Remote URL to stream from external sources',
  'help.guide.posters.title': 'Posters and Designs',
  'help.guide.posters.s1': 'In Content Library, New poster opens the Studio (Layerhub) editor for layered posters',
  'help.guide.posters.s2': 'Create design opens the Suika design editor in a new window (canvas sizes: landscape, portrait, e-paper)',
  'help.guide.posters.s3': 'Save / publish writes a PNG into the library; screens play the image offline — not the editor JSON',
  'help.guide.posters.s4': 'Edit poster / Edit design reopen the matching editor; the two formats are not interchangeable',
  'help.guide.posters.s5': 'On Slides, Background from Studio or Background from Design can set a slide photo from either editor',
  'help.guide.widgets.title': 'Using Widgets',
  'help.guide.widgets.s1': 'Go to Widgets and click "New Widget"',
  'help.guide.widgets.s2': 'Choose a type: Clock, Weather, RSS, Text, Webpage, or Social',
  'help.guide.widgets.s3': 'Configure the widget settings',
  'help.guide.widgets.s4': 'Assign the widget to a device via the Playlist tab',
  'help.guide.widgets.s5': 'Widgets render as live HTML content',
  'help.guide.ai.title': 'AI Content Design',
  'help.guide.ai.s1': 'Open Designer and click the gear on the "AI generate" panel',
  'help.guide.ai.s2': 'Add an OpenAI-compatible text endpoint + model (OpenAI cloud, or a local Ollama)',
  'help.guide.ai.s3': 'Optional: pick an image provider for AI backgrounds (OpenAI, or local Stable Diffusion / ComfyUI)',
  'help.guide.ai.s4': 'Type a prompt, click "Generate design", then tweak and Publish',
  'help.guide.ai.s5': 'Run it fully local + free — see docs/local-ai-setup.md',
  'help.guide.layouts.title': 'Multi-Zone Layouts',
  'help.guide.layouts.s1': 'Go to Layouts and create a new layout or use a template',
  'help.guide.layouts.s2': 'Drag zones to position them on the canvas',
  'help.guide.layouts.s3': 'Resize using the corner handle',
  'help.guide.layouts.s4': 'Assign the layout to a device in the Playlist tab',
  'help.guide.layouts.s5': 'Each zone can show different content',
  'help.guide.schedule.title': 'Content Scheduling',
  'help.guide.schedule.s1': 'Go to Schedule and select a device',
  'help.guide.schedule.s2': 'Click "Add Schedule" to create a time slot',
  'help.guide.schedule.s3': 'Set start/end times and recurrence rules',
  'help.guide.schedule.s4': 'Higher priority schedules override lower ones',
  'help.guide.schedule.s5': 'Content auto-switches based on the schedule',
  'help.guide.remote.title': 'Remote Control',
  'help.guide.remote.s1': 'Go to a device\'s detail page',
  'help.guide.remote.s2': 'Click the "Remote Control" tab',
  'help.guide.remote.s3': 'Click "Start Remote" to begin streaming',
  'help.guide.remote.s4': 'Use the d-pad, volume, and power buttons',
  'help.guide.remote.s5': 'Click anywhere on the screen to simulate a tap',
  'help.guide.kiosk.title': 'Kiosk/Touchscreen',
  'help.guide.kiosk.s1': 'Go to Kiosk and create a new page',
  'help.guide.kiosk.s2': 'Add buttons with labels, icons, and actions',
  'help.guide.kiosk.s3': 'Configure the idle screen timeout',
  'help.guide.kiosk.s4': 'Preview the page in the editor',
  'help.guide.kiosk.s5': 'Assign to a device as a widget',
  'help.guide.walls.title': 'Video Walls',
  'help.guide.walls.s1': 'Go to Video Walls and create a new wall',
  'help.guide.walls.s2': 'Drag displays onto the canvas and arrange them to match the PHYSICAL wall',
  'help.guide.walls.s3': 'Panel hung sideways? Select it and set "How this panel is mounted" — no need to pre-rotate your video',
  'help.guide.walls.s4': 'Set bezel compensation if needed, then "Fit player to screens"',
  'help.guide.walls.s5': 'Assign a playlist to play across all displays',
  'help.guide.walls.s6': 'The Panels list below the canvas shows each screen\'s online state and links to its device page',
  'help.guide.datasources.title': 'Calendar signs from Data Sources',
  'help.guide.datasources.s1': 'Connect a published Google or Outlook ICS under Data Sources',
  'help.guide.datasources.s2': 'Open Slides and click New deck',
  'help.guide.datasources.s3': 'Filter with All / Room / Facilities / Agenda / Blank and pick a card — door signs, a 4-room corridor board, waste, agenda. The preview is CSS, not a screenshot',
  'help.guide.datasources.s4': 'Continue, choose the calendar (or four for the corridor board), and set the room or board title',
  'help.guide.datasources.s5': 'Create the deck, then publish it to a playlist and a display',
  'help.guide.datasources.s6': 'Busy / free / next collection / tonight\'s agenda update on the next poll. You do not edit JSON',
  'help.faq.devices.q': 'What devices are supported?',
  'help.faq.devices.a': 'Android TV/tablets (APK), Raspberry Pi, Windows, ChromeOS, LG webOS, Samsung Tizen, Fire TV, and any device with a web browser.',
  'help.faq.trial.q': 'How does the free trial work?',
  'help.faq.trial.a': 'New accounts get a 14-day free trial of the Pro plan (15 devices, all features). After 14 days, you\'re moved to the Free plan (1 device) unless you upgrade.',
  'help.faq.portrait.q': 'Can I use portrait mode displays?',
  'help.faq.portrait.a': 'Yes! Set the orientation to "Portrait" in the device\'s Info tab. The content will be rotated accordingly.',
  'help.faq.offline.q': 'What happens when a device goes offline?',
  'help.faq.offline.a': 'Devices cache content locally, so they continue playing their playlist even without internet. You\'ll receive an email alert after 5 minutes of being offline.',
  'help.faq.selfhost.q': 'Can I self-host {brandName}?',
  'help.faq.selfhost.a': 'Yes! Deploy the server on your own infrastructure. All data stays on your network. Set SELF_HOSTED=true in the environment.',
  'help.faq.update.q': 'How do I update the Android app?',
  'help.faq.update.a': 'The app checks for updates automatically every 30 minutes. You can also force an update from the device\'s Info tab in the dashboard.',
  'help.faq.formats.q': 'What video formats are supported?',
  'help.faq.formats.a': 'MP4 (H.264), WebM, AVI, MKV, MOV. For best compatibility, use MP4 with H.264 encoding.',
  'help.faq.whitelabel.q': 'Can I white-label the dashboard?',
  'help.faq.whitelabel.a': 'Yes! Go to Settings > White Label to customize the brand name, colors, logo, and domain.',
  'help.faq.reports.q': 'How do I export proof-of-play reports?',
  'help.faq.reports.a': 'Go to Reports, set your date range and filters, then click "Export CSV".',
  'help.faq.wall.q': 'What is a video wall?',
  'help.faq.wall.a': 'A video wall combines multiple displays into one large screen. For example, four TVs in a 2x2 grid showing one big image/video.',
  'help.faq.wall_portrait.q': 'How do I build a wall from portrait (sideways-mounted) panels?',
  'help.faq.wall_portrait.a': 'Arrange the tiles on the wall canvas exactly as the panels are hung — side by side stays side by side. Then select each tile and set "How this panel is mounted" to match how it was turned. The player rotates the content for you, so you do not need a pre-rotated copy of your video. While a display is in a wall, this setting replaces its own Orientation.',
  ...
  'trigger.intro': 'Let an external system — a Crestron or Extron panel, a PLC, a button — put a playlist over whatever a screen is showing. Resolved on the screen itself, so it keeps working when the internet does not.',
  'trigger.empty': 'No triggers yet.',
  'trigger.new': 'New trigger',
  'trigger.edit': 'Edit trigger',
  'trigger.name': 'Name',
  'trigger.tokens': 'Fire / clear',
  'trigger.match_token': 'Fire token',
  'trigger.clear_token': 'Clear token',
  'trigger.token_hint': 'The exact text the external system sends. Letters, digits and punctuation — no spaces, because it travels as one line.',
  'trigger.target': 'Plays',
  'trigger.target_hint': 'The playlist to show. Its media is downloaded and kept on every assigned screen, so the trigger still works offline.',
  'trigger.target_missing': '(playlist deleted)',
  'trigger.mode': 'Mode',
  'trigger.mode_once': 'Play once',
  'trigger.mode_until_cleared': 'Hold until cleared',
  'trigger.max_duration': 'Maximum length (seconds)',
  'trigger.max_duration_hint': 'A safety cap for play-once. 0 means play the whole playlist. If the playlist is longer than the cap, the cap wins.',
  'trigger.lease': 'Auto-clear after (seconds)',
  'trigger.lease_hint': 'Optional. Clears itself if the sender stops repeating the trigger. Each repeat renews it.',
  'trigger.lease_risk': 'No auto-clear: if the clear message is lost, this screen holds the overlay until someone clears it by hand.',
  'trigger.lease_risk_banner': 'One or more triggers hold until cleared over UDP with no auto-clear set. If a clear message is lost, those screens stay covered until someone clears them by hand.',
  'trigger.no_lease': 'no auto-clear',
  'trigger.priority': 'Priority',
  'trigger.sources': 'Accepts',
  ...
  'trigger.none_available': 'None available.',
  ...
  'history.pick_hint': 'Pick a revision to preview it, or Compare two to see what changed. Restore copies a revision into a new draft; the live version is untouched until you publish.',
  'history.empty': 'No revisions yet. The first save records one.',
  'history.live': 'Live',
  'history.published_at': 'published {when}',
  'history.baseline_hint': 'recorded from the existing item when history was introduced',
  'history.actor_baseline': 'existing state',
  'history.actor_import': 'import',
  'history.actor_mesh': 'mesh sync',
  'history.actor_api': 'API token',
  'history.actor_system': 'system',
  'history.actor_unknown': 'unknown author',
  'history.compare': 'Compare',
  'history.compare_selected': 'Comparing from here',
  'history.compare_pick_second': 'Now pick the revision to compare against.',
  'history.changes_vs': 'Changes compared with {label}',
  'history.no_changes': 'No differences.',
  'history.reordered': 'Items were reordered.',
  'history.restore': 'Restore',
  'history.restore_confirm': 'Restore revision #{n} into a new draft? The live version keeps playing until you publish.',
  'history.restored_toast': 'Revision #{n} restored as a new draft.',
  'history.next_submit': 'Restored as a draft. Submit it for review to release it.',
  'history.next_publish_draft': 'Restored as a draft. Publish the draft to release it.',
  'history.next_publish': 'Restored as a draft. Publish to release it.',
  'history.note_approval_on': 'This workspace requires approval. Restored drafts must be reviewed before they can go live.',
  'history.note_approval_off': 'Restore never changes what is playing; only publishing does.',
  'history.bytes_gone': 'The file for this revision is no longer retained, so it cannot be previewed or restored.',
  'history.remote_url_note': 'External content: the URL is what was saved, the page behind it is live data and is not versioned.',
  'history.has_schedule': 'scheduled',
  'history.slides': 'slides',

  // Approval workflow
  'review.title': 'Reviews',
  'review.sub_reviewer': 'You are a reviewer for this workspace. Approving records your decision; publishing is a separate step.',
  'review.sub_member': 'Submissions waiting for a reviewer. You can withdraw your own.',
  'review.sub_off': 'This workspace does not require approval. Publishing goes live immediately. A workspace admin can change this under Members.',
  'review.filter.open': 'Open',
  'review.filter.all': 'All',
  'review.filter.mine': 'My submissions',
  'review.pick_hint': 'Select a submission to see what changed, preview it, and decide.',
  'review.empty': 'Nothing to review.',
  'review.type.content': 'Content',
  'review.type.playlist': 'Playlist',
  'review.type.layout': 'Layout',
  'review.type.slide_deck': 'Slide deck',
  'review.type.widget': 'Widget',
  'review.status.submitted': 'Awaiting review',
  'review.status.approved': 'Approved',
  'review.status.changes_requested': 'Changes requested',
  'review.status.published': 'Published',
  'review.status.withdrawn': 'Withdrawn',
  'review.status.cancelled': 'Cancelled',
  'review.status.superseded': 'Superseded',
  'review.affects': 'Affects {n} screen(s) right now',
  'review.submitted_by': 'Submitted by {who} on {when}',
  'review.status_line': 'Status: {status}',
  'review.comment_label': 'Comment',
  'review.changes_since_live': 'Changes since the live version',
  'review.first_release': 'This item has never been published; everything is new.',
  'review.approve': 'Approve',
  'review.request_changes': 'Request changes',
  'review.publish_approved': 'Publish approved version',
  'review.withdraw': 'Withdraw',
  'review.submit': 'Submit for review',
  'review.resubmit': 'Resubmit for review',
  'review.publish_draft': 'Publish draft',
  'review.discard_draft': 'Discard draft',
  'review.discard_confirm': 'Discard the draft? The live version is unaffected.',
  'review.submit_note_prompt': 'Note for the reviewer (optional):',
  'review.approve_comment_prompt': 'Comment (optional):',
  'review.changes_comment_prompt': 'Tell the author what needs to change:',
  'review.self_approval_note': 'You cannot approve this: you submitted it or authored changes in it. Another reviewer must decide.',
  'review.state.awaiting': 'Awaiting review. Editing again will need a new submission.',
  'review.state.changes_requested': 'Changes requested: {comment}',
  'review.state.approved': 'Approved. Publishing is a separate step.',
  'review.state.draft_pending': 'Unpublished draft. Screens keep showing the live version.',
  'review.toast.submitted': 'Submitted for review.',
  'review.toast.withdrawn': 'Submission withdrawn.',
  'review.toast.approved': 'Approved. It goes live when published.',
  'review.toast.changes_requested': 'Changes requested.',
  'review.toast.published': 'Published.',
  'review.toast.discarded': 'Draft discarded.',
  ...
  'approval.blocked_single_user': 'This workspace has only one member, so nobody could review anyone else\'s work. Add a second editor or admin and assign them as a reviewer first.',
  'approval.blocked_no_reviewer': 'Assign at least one reviewer below before enabling.',
  'approval.on_effects': 'Approval is on. Editors submit changes; assigned reviewers approve or request changes; then the approved revision is published. Nobody can approve their own submission or one containing changes they authored.',
  'approval.reviewers': 'Reviewers',
  'approval.reviewers_explain': 'Only workspace admins and editors can be reviewers. Removing someone\'s access removes their ability to review immediately.',
  'approval.no_eligible': 'No eligible members.',
  'approval.pending_count': '{n} submission(s) currently pending.',
  'approval.enable_confirm': 'Enable approval? Live content keeps playing. From now on, publishing needs a reviewer.',
  'approval.disable_confirm': 'Disable approval? {n} pending submission(s) will be cancelled. Nothing is auto-published; their drafts and history are kept, and editors can publish them directly afterwards.',
  'approval.toast.saved': 'Approval settings saved.',
};
