...
export default {
  ...
  'data_sources.empty_desc': 'Connect an iCal / Webcal calendar link from Google Calendar, Outlook, Apple Calendar, or any public iCal feed. Bind live room status, the next meeting, today\'s agenda, or an empty-board hint to a slide with {{ds:slug.field}} — or start from Slides → New deck → Meeting Room Door Sign, Waste Collection Reminder, or Daily Office Agenda.',
