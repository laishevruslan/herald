...
- **Meeting-room signs** — Slides → New deck, filter Room, pick Meeting Room Door Sign, bind the room calendar, and publish. E-paper (800×480 Sticky, black/white) and TV 16:9 (green/red bar) share the same iCal source. After the last meeting of the day the resolver supplies a localised empty-board hint (`remaining_today_empty`) instead of leaving a `Next:  ()` line. The gallery is CSS cards with chips All / Room / Facilities / Agenda / Blank, not a radio list
