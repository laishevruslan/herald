...
T1 door signs, T2 waste reminders and T3 daily agenda ship from `server/lib/slide-templates.js` (`room-epaper-5x3`, `room-lcd-16x9`, `waste-epaper-5x3`, `waste-lcd-16x9`, `agenda-lcd-16x9`). The New Deck wizard is a card gallery (CSS thumbs, filter chips); it binds a data source before create.
