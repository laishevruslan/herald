...
1. Регистрация `/fonts` в Fabric до первого paint.
2. Цвета brand kit, если фаза 4 родителя есть.
3. Со слайда: «фон из Studio» / «редактировать постер».
4. Честная подпись для 800×480.
