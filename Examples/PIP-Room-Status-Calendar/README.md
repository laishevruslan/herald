...
**Deprecated as the default door-sign path.** New operators should use **Slides + Data Sources**
(phase 3): connect the room calendar under Data Sources, then Slides → New deck and pick a
Meeting Room Door Sign (e-paper 800×480, TV 16:9, or portrait tablet 9:16), a four-room corridor
board, waste reminder, or daily agenda. See
